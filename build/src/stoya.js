...
var git_manager_1 = require("./git-manager");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var options, helpMessage, gitmngr, status, localBranch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    gitmngr = new git_manager_1.GitManager('.');
                    return [4 /*yield*/, gitmngr.getStatus()];
                case 1:
                    status = _a.sent();
                    return [4 /*yield*/, gitmngr.checkoutReleaseBranchLocally('test')];
                case 2:
                    localBranch = _a.sent();
